  ...
  console.clear();
    ...
    .then(()=>{
      ...
      console.log(
        ...
        \nSaldo USDT Total: ${saldoTotalUSDT}\n\nSaldo\t\t\tÚltimo Preço\tOrdem Aberta`
      );
      ...
      for (let i in mercados) {
        binance.prevDay(mercados[i], (error, prevDay, prevDaySymbol) => {
          binance.balance((error, balances) => {
            binance.openOrders(mercados[i], (error, openOrders, openOrdersSymbol) => {
              binance.depth(mercados[i], (error, depth, depthSymbol) => {
                binance.prevDay("BTCUSDT", (error, prevDayBTC, btcChangeSymbol) => {
                  try {
                    ...
                    saldoUSDT = parseFloat(balances.USDT.available);
                    saldoTotalUSDT = controllers.calcularSaldo(balances, saldoTotalUSDT);
                    ...
                    var [
                      buyBoolean, 
                      buyAmount, 
                      buyPrice] = controllers.timeTobuy(depth.asks, compra, saldoUSDT)
                    ...
                    if (saldoUSDT > minimumTrade && buyBoolean) {
                      ...
                      try {
                        ...
                        controllers.sendMail(
                          ...
                          Saldo USDT total: ${saldoTotalUSDT}<br><br>
